...
<body>
    ...
    <main>
        ...
        <section class="FormReg">
            <form id="registroUsuario" name="registroUsuario" action="" method="post" enctype="multipart/form-data" autocomplete="on">
                ...
                <input type="text" id="apellidoPaterno" name="apellidoPaterno" size="30" maxlength="50" placeholder="Apellido Paterno" required=""><br>

                <label for="apellidoMaterno"></label>
                <input type="text" id="apellidoMaterno" name="apellidoMaterno" size="30" maxlength="50" placeholder="Apellido Materno" required=""><br>

                <label for="nombreUsuario"></label>
                <input type="text" id="nombreUsuario" name="nombreUsuario" size="30" maxlength="30" placeholder="Nombre" required=""><br>

                <label for="identificador"></label>
                <input type="text" id="identificador" name="identificador" size="30" maxlength="20" placeholder="Boleta/Numero de trabajador" required=""><br>


                <label for="correoElectronico"></label>
                <input type="email" id="correoElectronico" name="correoElectronico" size="30" placeholder="Correo Institucional" list="listaformatos" required="">
                <datalist>
                    <option>.com</option>
                    <option>.mx</option>
                ...
                <input type="password" name="contraseñaUsuario" id="contraseñaUsuario" placeholder="Ingrese una contraseña" maxlength="25" size="30" required=""> <br>
